...
HD_PWD='C:/Users/Musa/stj/stj.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RPN_Module.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RPN_Module.tcl -notrace
