...
HD_PWD='C:/Users/Musa/stj/stj.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RPN_Module.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RPN_Module.tcl
